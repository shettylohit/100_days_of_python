...
#Hint 4: Create a deal_card() function that uses the List below to *return* a random card. DONE
#11 is the Ace.
#cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]

#Hint 5: Deal the user and computer 2 cards each using deal_card() and append().  DONE
#user_cards = []
#computer_cards = []

#Hint 6: Create a function called calculate_score() that takes a List of cards as input DONE
...
if input("Do you want to pick another card: ") == "y":
    card= deal_cards()

...
computer_total = sum(dealer_card)


print(f"Your cards: {user_card[:2]} and Current score: {sum(user_card[:2])}")
print(f"Computer's cards: {dealer_card[0]}")
...
if new_card == "y":
  print(f"Your final hand: {user_card}, User final score: {user_total}")
  print(f"Dealer final hand: {dealer_card}, Dealer final score: {computer_total}")
else:
  print("stopped")

if user_total > 21 and computer_total >21:
  print("Its a bust, play again")
elif user_total == computer_total:
  print(f"your cards score {user_total} is equal to computer cards total{computer_total}, Its a Draw")
elif user_total > 21:
  print(f"Your total score {user_total} is greater than 21. You lose")
elif computer_total > 21:
  print(f"Computer total score {computer_total} is greater than 21. You win")
elif user_total > computer_total:
  print(f"You win")
elif user_total < computer_total:
